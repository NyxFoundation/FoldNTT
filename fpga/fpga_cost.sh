...
#   nix shell nixpkgs#yosys --command fpga/fpga_cost.sh
set -euo pipefail
cd "$(dirname "$0")/.."
...
F[modular_mul_kred]="kred-butterfly/modular_mul_kred.v"
F[compact_bf]="$RTL/compact_bf.v $RTL/modular_mul.v $RTL/modular_add.v $RTL/modular_substraction.v $RTL/common_lib.v"
F[compact_bf_v2]="kred-butterfly/compact_bf_v2.v kred-butterfly/modular_mul_kred.v $RTL/modular_add.v $RTL/modular_substraction.v $RTL/modular_half.v $RTL/common_lib.v"
F[tf_ROM]="$RTL/tf_ROM.v"
F[tf_rom_fold]="psi-fold-rom/tf_rom_fold.v"
