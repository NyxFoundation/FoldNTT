...
core top_poly_mul_v2 "$FC/top_poly_mul_v2.v" "$root/proposed/kred/compact_bf_v2.v" "$root/proposed/kred/modular_mul_kred.v" "$root/proposed/rom-fold/tf_rom_fold.v"
