...
#   nix shell nixpkgs#yosys --command proposed/fpga_cost_core.sh
#
# Notes:
...
measure top_poly_mul_v2 "$FC/top_poly_mul_v2.v proposed/kred/compact_bf_v2.v proposed/kred/modular_mul_kred.v proposed/rom-fold/tf_rom_fold.v" /tmp/core_v2.txt
