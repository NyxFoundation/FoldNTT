...
| # | Phase | Output | Status |
|---|-------|--------|--------|
| 1 | Related-work sweep (novelty check: K-RED in hardware, twiddle generation/compression, verified NTT hardware, Falcon q=12289 accelerators) | `docs/related-work.md` | IN PROGRESS |
| 2 | Novelty assessment; adjust claims | claims section in `docs/related-work.md` | pending |
| 3 | FSM reconstruction + full-core RTL simulation (verilator) vs golden polymult | `proposed/fullcore/` + `docs/evaluation.md` §sim | pending |
